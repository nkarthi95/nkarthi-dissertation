Stimuli responsive emulsions have seen interest for use in fields such
as enhanced oil recovery, porous material templates, in-situ reaction
seperation systems and drug delivery scaffolds.
\cite{tang_stimuli-responsive_2016,} \cite{bago_rodriguez_capsules_2019}
These applications are enabled through stimuli response driven
microstructure modification, changing the permeability, sueface area and
morphology of the emulsion. Leveraging advances in particle synthesis
techniques and citing concerns over surfactant toxicity and
environmental concerns, particle stabilized emulsions have made a
resurgence in popularity after their discovery in 1907 by Ramsden and
Pickering. \cite{rozynek_opening_2019} \cite{zhou_magnetic_2011} Stimuli
response has been enabled in particle stabilized emulsions using pH,
temperature or chemical composition changes.
\cite{maingret_dextran-based_2020} \cite{lin_ph-responsive_2018}
\cite{raju_ph-responsive_2018} \cite{zhang_ph_2022}

Owing to its tortuous, co-continuous domain morphology, bicontinuous
interfacially jammed emulsion gels (bijel) are studied for their
possible applications to fabricate membranes, catalyst supports, battery
electrodes and pharmaceutical products. \cite{yabuno_preparation_2020}
\cite{samdani_bicontinuous_2017} \cite{cha_bicontinuous_2019}
\cite{garcia_scalable_2019} \cite{santiago_cordoba_aerobijels_2020}
Bijels are formed through the arresting of spinodal decomposition of
partially miscible fluids. \cite{stratford_colloidal_2005}
\cite{herzig_bicontinuous_2007} \cite{tavacoli_novel_2011} Once phase
separation begins, the incipient interface begins to sweep through the
system causing particles to begin to adsorbing into it. Once the
interfacial area matches that of the cross sectional area of the
adsorbed particles, the structure jams in place.
\cite{stratford_colloidal_2005} \cite{herzig_bicontinuous_2007}
\cite{tavacoli_novel_2011} After their discovery in simulations and
subsequent synthesis in experiments, a rich diversity of bijel
literature has developed around various fluid systems that allow for
bijel synthesis, methods to fabricate them at scale and their
applications.
